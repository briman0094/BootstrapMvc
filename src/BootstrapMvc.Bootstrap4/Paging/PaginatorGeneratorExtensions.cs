...
namespace BootstrapMvc
{
    public static class PaginatorGeneratorExtensions
    {
		...
		public static IItemWriter<PaginatorGenerator> ButtonsHtml(this IItemWriter<PaginatorGenerator> target, string currentPageTemplate, string previousPageText, string nextPageText)
		{
			target.ButtonsText( currentPageTemplate, previousPageText, nextPageText );
			target.Item.ButtonTemplatesAreHtml = true;
			return target;
		}
